...
module.exports = function(){
  if(environment()==="file"){
    ...
    var contents = fs.readFileSync(`${getUserHome()}/.node_repl_history`, "utf8");
    //var lastCommand = contents.split('\n')[0];
    //while(lastCommand == lastCommand){
      //console.log('waiting...');
      //contents = fs.readFileSync(`${getUserHome()}/.node_repl_history`, "utf8");
      //lastCommand = contents.split('\n')[0];
    //}
